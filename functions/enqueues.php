...
function fst_enqueues() {
  ...
  wp_register_style('normalize-css', get_template_directory_uri() . '/css/normalize.css', false, '3.0.3', null);
	wp_enqueue_style('normalize-css');

  wp_register_style('foundation-css', get_template_directory_uri() . '/css/foundation.min.css', false, '5.5.2', null);
  ...
  // Register and enqueue JavaScripts
	...
	wp_register_script('jquery', get_bloginfo('template_url').'/js/vendor/jquery.js', false, '2.1.4', true);
